# zadanie 10 lista 3
# szyfr Cezara - deszyfrator z dowolnym przesunięciem
...
wiersz_użytkownika = input("Podaj wiersz tekstu do odszyfrowania szyfrem Cezara: ")
...
przesunięcie = -1 * (przesunięcie % 26)
